...
// Python bridge over LAN
#define BRIDGE_SERVER_IP "192.168.0.103"
#define BRIDGE_SERVER_PORT 5051
#define BRIDGE_TOKEN "zmien_to_haslo"
#define BRIDGE_IDLE_TIMEOUT_MS 20000UL
#define BRIDGE_ARP_TIMEOUT_MS 350UL
#define BRIDGE_WORKERS 256UL
